...
```console
python -m onnxruntime.quantization.qdq_preprocess --input mobilenetv2-7.onnx --output mobilenetv2-7-infer.onnx
```
...
```console
python -m onnxruntime.quantization.qdq_preprocess --help
```
...
```console
python -m onnxruntime.quantization.qdq_preprocess --input abc_float32_model.onnx --output abc_optimized.onnx --skip_symbolic_shape True
```
