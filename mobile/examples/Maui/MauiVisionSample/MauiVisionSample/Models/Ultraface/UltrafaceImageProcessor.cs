...
namespace MauiVisionSample
{
    public class UltrafaceImageProcessor : SkiaSharpImageProcessor<UltrafacePrediction, float>
    {
        ...
        protected override void OnApplyPrediction(UltrafacePrediction prediction, SKPaint textPaint, SKPaint rectPaint, SKCanvas canvas)
        {
            var text = $"{prediction.Confidence:0.00}";
